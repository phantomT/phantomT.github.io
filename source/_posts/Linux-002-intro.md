...
![Linux系统开源软件与包的展示](Free_and_open-source-software_display_servers_and_UI_toolkits.svg.png)
...
![Linux服务器LAMP环境](660px-LAMP_software_bundle.svg.png)
...
![Linux组成](linux_observability_tools.png)
...
![Linux内核展示](Linux_kernel_map.png)
![Linux内核的漫画表示](182127x7wi7obls96k8yb5-1000x1008.gif)
![Linux内核位置](660px-Linux_kernel_ubiquity.svg.png)
...
作为一个大的系统组织框架，Debian旗下有多种不同操作系统核心的分支计划，主要为采用Linux核心的Debian GNU/Linux系统，其他还有采用GNU Hurd核心的Debian GNU/Hurd系统、采用FreeBSD核心的Debian GNU/kFreeBSD系统等。**众多知名的Linux发行版，**例如Ubuntu、Knoppix和Deepin，也**都建基于Debian GNU/Linux。**(其实我见到的第一个Linux发行版试Knoppix= =，老爸给我做了一个启动盘是Knoppix的，不过。。。默认界面还有程序命名都好难受😑)
...
![正在运行GNOME 3.22的Debian 9](600px-GNOME_Shell_with_GNOME_Clocks,_Evince,_gThumb_and_GNOME_Files_at_version_3.22_(2016,_09)_in_Dark_mode.png)
...
![Ubuntu18.04LTS从Unity换回了Gnome界面](Ubuntu_18.04.png)
...
![Deepin15.5桌面截图（使用Marea图标主题）](DeepinScreenshot20180316.png)
...
![Arch Logo](125335ssqoqh2qjqbsk9h2.png)
...
![Manjaro_17.0_Gellivara](Manjaro_17.0_Gellivara.png)
...
![安装了Luci界面的Openwrt](LuCI_0.10_software_zh_cn.png)
![暑假用的Openwrt的登录界面](login.png)
![以LEDE为名继续的Openwrt项目](Lede.png)
...
有一张网传选择系统的图片  
![选择系统|仅供参考](v2-e8043a65d3450a009b3d9a06ca6b06f1_hd.jpg)
...
- 自己剪坏的水晶头，就是跪着也要接好ORZ
- **差不多了，祝大家学习Linux顺利。**
![](5d6034a85edf8db13f07e3fc0923dd54564e7479.jpg)
![](v2-006e2bef4a8bcc82b0eeb88f6d759d6d_hd.jpg)
...
![🤔](v2-3d2cc9327032abce40deaa30bd184571_hd.jpg)

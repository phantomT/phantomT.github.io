...
## VPS
* VPS可以选择去www.vultr.com注册一个账号然后买一个洛杉矶的服务器(测试一下哪个延时低和速度快选哪个)，可以使用支付宝付款的。
...
### 问题遗留
其实还是有一些问题的，比如路由器不能转换ipv6地址(好像是这么描述的)就是连接路由器以后就无法使用ipv6了，也就是说Wi-fi与ipv6不能一起用诶。还没有想出好的方法，真的还需要好好学习一个。
希望自己也可以成为大佬>_<
